                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('articles.update', $article) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="6" required>{{ old('description', $article->description) }}</textarea>
                        ...
                        <div>
                            ...
                            @else
                                <p class="text-gray-500 mt-2">No hay imágenes cargadas para este artículo.</p>
                            @endif
                        </div>
