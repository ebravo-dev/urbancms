<x-app-layout>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required value="{{ old('title') }}">
                            @error('title')
                        ...
                        <div class="mb-6 border-t border-b border-gray-200 py-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="meta_title" id="meta_title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('meta_title') }}" maxlength="70" oninput="updateSeoPreview()">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="meta_description" id="meta_description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" maxlength="160" oninput="updateSeoPreview()">{{ old('meta_description') }}</textarea>
                                <div class="mt-1 flex justify-between">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="keywords" id="keywords" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('keywords') }}" placeholder="ejemplo, blog, artículo">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="rounded border border-gray-200 p-4">
                                    <div id="seo_preview_title" class="text-xl text-blue-600">Meta título aquí</div>
                                    <div class="text-green-700 text-sm">example.com/blog/titulo-del-articulo</div>
                                    <div id="seo_preview_description" class="text-sm text-gray-700">Meta descripción aquí...</div>
                                </div>
                            </div>
                        </div>

                        <div class="mb-4">
                            <label for="images" class="block text-sm font-medium text-gray-700">Imágenes (puede seleccionar múltiples)</label>
                            ...
                            <input type="file" name="images[]" id="images" class="mt-1 block w-full" multiple accept="image/*,.webp" onchange="previewImages(event)">
                            @error('images.*')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <!-- Contenedor para la vista previa de imágenes -->
                            <div id="imagePreviewContainer" class="mt-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4"></div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Inicializar los bloques con un párrafo vacío por defecto si no hay contenido
            initBlocksEditor();
        ...
        function initBlocksEditor() {
            // Por defecto añadimos un párrafo vacío si no hay bloques
